  ...
  return (
    <div className="static-page max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="glass-card p-8 space-y-6 text-gray-300">
        ...
        <p>
          By accessing and using LabelSnap, you accept and agree to be bound by the terms and provision of this agreement.
        </p>

        <h3 className="text-xl font-bold text-white mt-6">2. Use of Service</h3>
        <p>
          LabelSnap provides a free, browser-based tool for cropping e-commerce shipping labels. The tool is provided "as is" without any guarantees. You are solely responsible for verifying the accuracy of the cropped labels before printing or shipping.
        </p>

        <h3 className="text-xl font-bold text-white mt-6">3. No Liability</h3>
        <p>
          LabelSnap shall not be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:
        </p>
        ...
        <p>
          The service and its original content, features, and functionality are and will remain the exclusive property of LabelSnap and its licensors.
        </p>
